@echo off
rem ==========================================================================
rem Product: QDPP example for DOS, uC/OS-II port, Turbo C++ 1.01 compiler
...
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\philo.obj    %SRCDIR%\philo.cpp
%CC% %CCFLAGS% %CCINC% -o%BINDIR%\table.obj    %SRCDIR%\table.cpp
