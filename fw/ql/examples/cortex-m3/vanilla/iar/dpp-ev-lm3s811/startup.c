/*****************************************************************************
* Product: Startup code and Interrupt Vector Table for Cortex-M3, Vanilla
...
*/
static unsigned long stack[100] @ ".noinit";
...
__root VectorTableEntry const __vector_table[] @ ".intvec" = {
    ...
    (ISR)0,                               /* Reserved                       */
    (ISR)0,                               /* Reserved                       */
    &ISR_DefaultHandler,                  /* SVCall handler                 */
    &ISR_DefaultHandler,                  /* Debug monitor handler          */
    (ISR)0,                               /* Reserved                       */
    &ISR_DefaultHandler,                  /* The PendSV handler             */
    &ISR_SysTick,                         /* The SysTick handler            */
    &ISR_DefaultHandler,                  /* GPIO Port A                    */
    ...
    &ISR_DefaultHandler,                  /* ADC Sequence 3                 */
